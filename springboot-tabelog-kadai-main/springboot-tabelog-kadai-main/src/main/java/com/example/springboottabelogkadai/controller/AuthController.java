...
import com.example.springboottabelogkadai.event.SignupEventPublisher;
import com.example.springboottabelogkadai.form.SignupForm;
import com.example.springboottabelogkadai.service.UserService;
import com.example.springboottabelogkadai.service.VerificationTokenService;
...
public class AuthController {
	...
	public String signup(@ModelAttribute @Validated SignupForm signupForm, BindingResult bindingResult,
		...
		if (userService.isEmailRegistered(signupForm.getMail())) {
